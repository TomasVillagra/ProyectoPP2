...
export default function InsumoEditar() {
  ...
  return (
    <DashboardLayout>
      <h2 style={{ margin: 0, marginBottom: 12 }}>Editar Insumo</h2>
      {msg && <p style={{ marginBottom: 12 }}>{msg}</p>}

      <form onSubmit={onSubmit} className="form">
        <div className="row">
          <label htmlFor="ins_nombre">Nombre =</label>
          <input id="ins_nombre" name="ins_nombre" value={form.ins_nombre} onChange={onChange} required />
        </div>
        <div className="row">
          <label htmlFor="ins_unidad">Unidad =</label>
          <input id="ins_unidad" name="ins_unidad" value={form.ins_unidad} onChange={onChange} required />
        </div>
        <div className="row">
        ...
        <div className="row">
          ...
          <input id="ins_stock_max" name="ins_stock_max" type="number" step="0.01" value={form.ins_stock_max} onChange={onChange} placeholder="(opcional)" />
        </div>
